...
\about{Do research and create computational methods for solving technical and business problems. \\Solid track record in the design and implementation of software systems. \\Act as an ambassador for products, internally and externally and I asses initiatives' value. 
     }
...
\section{Patents}
\begin{twenty}
\patent{2021}{\href{https://bit.ly/3gacILv}{Converter system and computer-implemented method}.}{ \href{https://bit.ly/3gacILv}{ 16/687,951} Granted}
\patent{2018}{System, computer-implemented method and computer program product for information retrieval.}
{Request~pending}

\patent{2018}{Computer-implemented method, system product for providing a conversational application interface.}{Request~pending}

\patent{2019}{"Computer-implemented converter method for multi-component systems  and non-transitory storage medium.}{Request~pending}
\end{twenty}
